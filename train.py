...
train = pd.read_csv(r'C:\Users\Admin\Desktop\kaggle\Emplay\preprocessed\train.csv', dtype={'date': str, 'fullVisitorId': str, 'sessionId':str, 'visitId': np.int64})
test = pd.read_csv(r'C:\Users\Admin\Desktop\kaggle\Emplay\preprocessed\test.csv', dtype={'date': str, 'fullVisitorId': str, 'sessionId':str, 'visitId': np.int64})

# Getting data from leak
train_store_1 = pd.read_csv(r'C:\Users\Admin\Desktop\kaggle\Emplay\preprocessed\Train_external_data.csv', low_memory=False, skiprows=6, dtype={"Client Id":'str'})
train_store_2 = pd.read_csv(r'C:\Users\Admin\Desktop\kaggle\Emplay\preprocessed\Train_external_data_2.csv', low_memory=False, skiprows=6, dtype={"Client Id":'str'})
test_store_1 = pd.read_csv(r'C:\Users\Admin\Desktop\kaggle\Emplay\preprocessed\Test_external_data.csv', low_memory=False, skiprows=6, dtype={"Client Id":'str'})
test_store_2 = pd.read_csv(r'C:\Users\Admin\Desktop\kaggle\Emplay\preprocessed\Test_external_data_2.csv', low_memory=False, skiprows=6, dtype={"Client Id":'str'})
